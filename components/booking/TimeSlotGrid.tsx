...
interface TimeSlotGridProps {
  ...
  loading: boolean;
  selectedDate: string;
  maxCapacity: number; // Receive Dynamic Limit
}
          ...
          return (
            <label
              ...
              className={`
                ...
                ${isFull
                  ? 'bg-slate-50 border-transparent opacity-50 cursor-not-allowed pointer-events-none' // DISABLED VISUALS
            ...
            >
              <input
                ...
                name="time"
                value={slot}
                disabled={isFull} // DISABLED INPUT
                required
