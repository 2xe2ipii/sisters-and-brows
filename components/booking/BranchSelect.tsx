...
export default function BranchSelect({ branches, selected, onSelect }: BranchSelectProps) {
  return (
    <SectionContainer title="Select Branch" icon={<MapPin className="w-4 h-4 text-[#e6c200]" />}>
        ...
        {branches.map((b) => {
          ...
          return (
            <button
              ...
              className={`
                px-5 py-3 rounded-xl text-sm font-bold border-2 transition-all flex-1 min-w-[140px] shadow-sm
                ${isSelected 
